...
#         return self.fc4(x)
    ...
    # def __init__(self, state_size, action_size, seed, n_agents=2, fcs1_units=256, fc2_units=128):
...
#     def __init__(self, state_size, action_size, seed, n_agents=2, fcs1_units=200, fc2_units=150):
#         super(Critic, self).__init__()
#         self.seed = torch.manual_seed(seed)
